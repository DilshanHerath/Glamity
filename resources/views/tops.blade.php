...
<section class="sec1">
    ...
    <div style="background: #bfb6b6;height: 80px;align-items: center;justify-content: center;display: flex">
        <h2 class="tittle2">Tops</h2>
    </div>

    <div style="display: flex;justify-content: center;align-items: center">
        <div class="row"
             style="width: 100%;display: flex;align-items: center;justify-content: center;margin-top: 5%">
            @foreach(($Tops->where('cat_id','17')) as $tops)
            <div class="col-12 col-sm-6 col-md-6 col-xl-3 div2">
                <div class="card cardbody" style="width: 300px">
                    <img src="{{url('storage/'.$tops->image) }}" class="card-img-top image" alt="..." data-bs-toggle="modal"
                         data-bs-target="#staticBackdrop">
                    <div class="card-body" style="background: white;">
                        <div style="display: flex;flex-direction: row;justify-content: space-between">
                            <h5 style="text-align: center;margin: 0;font-weight: bold;font-size: 18px"
                                class="card-title">{{ $tops->name }}</h5>
                            <p style="text-align: center;margin: 0" class="card-text">{{ $tops->material }}</p>
                            <p style="text-align: center;margin: 0" class="card-text">Rs {{ $tops->price }}/-</p>
                        </div>
                ...
                <div class="modal-body">
                    <div style="justify-content: center;align-items: center;display: flex">
                        <div class="card " style="width: 18rem;border: none">
                            <img src="../../images/top/top1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <div class="card mb-3" style="max-width: 540px;border: none">
                ...
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="../../images/top/top2.jpg" class="card-img-top" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
            ...
            <div class="card mb-3" style="max-width: 540px;border: none">
                ...
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="../../images/top/top3.jpg" class="card-img-top" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
