...
<section class="sec1">
    ...
    <div style="background: #bfb6b6;height: 80px;align-items: center;justify-content: center;display: flex">
        <h2 class="tittle2">{{$category_name}}</h2>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 my-2">
                <div class="card cardbody ">
                    <img src="{{url('storage/'.$item->image) }}" class="card-img-top image" alt="Item_image"
                         onclick='showItemDetails(@json($item));'
                         width="100%" >
            ...
            @endforeach
            @else
<p class="text-center h3 text-danger"> No Item Found</p>
            @endif
                ...
                <div class="modal-body">
                    <div style="justify-content: center;align-items: center;display: flex">
                        <div class="card " style="width: 18rem;border: none">
                            <img id="modal_image" src="../../images/top/top1.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 style="text-align: center;margin: 0" id="modal_product_name" class="card-title">GL001</h5>
                                <p style="text-align: center;margin: 0" id="modal_product_meterial" class="card-text">Cotton</p>
                                <p style="text-align: center;margin: 0" id="modal_product_price" class="card-text">Rs 1200/-</p>
                                <hr>
                                <p style="text-align: center;margin: 0;color: red;font-size: 13px;margin-bottom: 3%"
                                   class="card-text"> * Please Select Option</p>
                                <div style="justify-content: center;align-items: center;display: flex">
                                    <p>STYLE SIZE</p>
                                </div>
                                <div
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="col-12">
                ...
                <br><br>
                <button style="width: 100%; border: 2px solid black;color: black;background: transparent" type="button"
...
<script>
    function showItemDetails(item_datas) {

       console.log(item_datas);
        console.log("-------------------------");
        // console.log( "{{ Illuminate\Support\Js::from(url('storage/')) }}");
        // var item=JSON.parse(item_datas);
        // console.log(item);
        var storerage_url= {{ Illuminate\Support\Js::from(url('storage')) }};

        document.getElementById("modal_image").src = storerage_url+"/"+item_datas['image'];
        // $("#modal_image").src(item_datas[storerage_url+'image']);
        $("#modal_product_name").html(item_datas['name']);
        $("#modal_product_meterial").html(item_datas['material']);
        $("#modal_product_price").html("LKR " + item_datas['price']);
